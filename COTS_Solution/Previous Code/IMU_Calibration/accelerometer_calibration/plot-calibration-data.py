...
A = np.array([[0.999371, -0.000365, -0.000939],  # 'A^-1' matrix from Magneto
              [-0.000365, 1.001050, 0.000545],
              [-0.000939, 0.000545, 0.995865]])
# 'Combined bias (b)' vector from Magneto
b = np.array([-0.041430, 0.117302, -0.016241])

# Read raw data and apply calibration
rawData = np.genfromtxt('accelerometer_calibration/acceldata.txt',
