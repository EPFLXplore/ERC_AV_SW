...
//uint16_t Read16(INA219_t *ina219, uint8_t reg)
//{
//	HAL_I2C_Master_Transmit(ina219->i2cHandle, (INA219_ADDRESS<<1), &reg, 1, 10);
//	uint8_t pData[2] = { 0, 0 };
//	HAL_I2C_Master_Receive(ina219->i2cHandle, (INA219_ADDRESS<<1), pData, 2, 10);
...
//	if (HAL_I2C_Master_Transmit(ina219->i2cHandle, (INA219_ADDRESS<<1), &reg, 1, 10) != HAL_OK)
//		return HAL_ERROR;
//	uint8_t pData[2] = { 0, 0 };
//	if (HAL_I2C_Master_Receive(ina219->i2cHandle, (INA219_ADDRESS<<1), pData, 2, 10) != HAL_OK)
//		return HAL_ERROR;
//	ina219->current = ((pData[0] << 8) | pData[1]);
//	return HAL_OK;
//	HAL_StatusTypeDef status = HAL_I2C_Master_Receive(ina219->ina219_i2c, (INA219_ADDRESS<<1), &Register, 2, HAL_MAX_DELAY);
	uint8_t Value[2];
