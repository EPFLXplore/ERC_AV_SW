...
typedef struct
{
	...
	GPIO_TypeDef* EN_Port1; //!< flow control pin: 0=USB or RS-232 mode, >1=RS-485 mode
	GPIO_TypeDef* EN_Port2; //!< flow control pin: 0=USB or RS-232 mode, >1=RS-485 mode
	uint16_t EN_Pin1;  //!< flow control pin: 0=USB or RS-232 mode, >1=RS-485 mode
	uint16_t EN_Pin2;  //!< flow control pin: 0=USB or RS-232 mode, >1=RS-485 mode
