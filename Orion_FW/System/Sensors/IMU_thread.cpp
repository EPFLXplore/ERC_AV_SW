...
//	printf("%.6f,%.6f,%.6f\n",mag.x, mag.y, mag.z);
	...
	QuaternionUpdate(imu_data.accel.x, imu_data.accel.y, imu_data.accel.z,
...
void IMUThread::QuaternionUpdate(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz, float dt){
