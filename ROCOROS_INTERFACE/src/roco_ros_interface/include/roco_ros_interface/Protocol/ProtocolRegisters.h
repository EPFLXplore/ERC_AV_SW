...
REGISTER(avionics_caching_success_packet)
REGISTER(sc_trap_packet)
REGISTER(avionics_trap_success_packet)
REGISTER(sc_LED_packet)
REGISTER(hd_voltmeter_motor_packet)
REGISTER(avionics_voltmeter_motor_status_packet)
REGISTER(hd_voltmeter_tare_packet)
REGISTER(avionics_voltmeter_tare_success_packet)
REGISTER(sc_mass_calibrate_packet)
REGISTER(avionics_mass_calibrate_success_packet)
REGISTER(Power_SystemPacket)
REGISTER(Power_VoltagePacket)
REGISTER(Power_CurrentPacket)
REGISTER(Reset_PowerSupplyPacket)
