...
/*=========================================================================
  I2C ADDRESS/BITS
  -----------------------------------------------------------------------*/
#define ADS1113_ADDRESS (0x48) ///< 1001 000 (ADDR = GND)
/*=========================================================================*/
...
public:
	ADS1115(I2C_HandleTypeDef *hi2c, uint8_t i2cAddress = ADS1113_ADDRESS);
	void startComparator_SingleEnded(uint8_t channel, int16_t threshold, uint16_t sampleRate=ADS1015_REG_CONFIG_DR_1600SPS);
	uint16_t readADC_SingleEnded(uint8_t channel, uint16_t sampleRate=ADS1015_REG_CONFIG_DR_1600SPS);
