...
#define UART_BUFFER_SIZE    512		            // SHOULDN'T BE BIGGER THAN 255 (RELATED TO MESSAGEBUS), OTHERWISE BIG ISSUES
#define THREAD_STACK_SIZE   2048                // DON'T CHANGE IF NOT NECESSARY TO DO SO
