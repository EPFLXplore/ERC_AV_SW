...
void LEDStrip::handleMode(uint8_t idx) {
    ...
    switch (cmd.mode) {
        ...
        case 2: mode2(idx, start, end, cmd.segment.r, cmd.segment.g, cmd.segment.b); break;
        case 3: mode3(idx, start, end, cmd.segment.r, cmd.segment.g, cmd.segment.b); break;
        case 4: mode4(idx, start, end, cmd.segment.r, cmd.segment.g, cmd.segment.b); break;
        case 5: mode5(idx, start, end); break;
